...
@WebServlet("/Cheque_Collection")
public class Cheque_Collection extends HttpServlet {
	private static final long serialVersionUID = 1L;
      ...
      Class.forName("com.mysql.jdbc.Driver");
    			...
    			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/medicine","root","root");
                   ...
                   PreparedStatement ps=con.prepareStatement("insert into cheque_collection values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                ...
                ps.setString(11,cheque_no);
                ps.setString(12,bank_name);
                
                
                
                ps.setString(13,collection_person);
    			...
    			if(i!=0){
  			       ...
  			       pw.println("alert('Your cheque is accepted successfully');");
  			       pw.println("</script>");
    				...
    				//response.sendRedirect("accept_order.html");
    	              ...
    	              RequestDispatcher rd = request.getRequestDispatcher("cheque_collection.html");		  
