...
/**
 * Servlet implementation class Deliver_Order
 */
@WebServlet("/Deliver_Order")
public class Deliver_Order extends HttpServlet {
	 	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try
			{
				...
				String delivery_boy = request.getParameter("delivery_boy");
				...
				Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/medicine","root","root");
	               ...
	               PreparedStatement ps=con.prepareStatement("insert into deliver_order values(?,?,?,?,?,?,?,?)");
				...
				if(i!=0){
					...
					//response.sendRedirect("accept_order.html");
		              ...
		              RequestDispatcher rd = request.getRequestDispatcher("order_dilivery.html");		  
